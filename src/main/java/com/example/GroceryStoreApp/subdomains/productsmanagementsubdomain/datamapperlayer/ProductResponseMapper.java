...
public interface ProductResponseMapper {
    ...
    @Mapping(expression = "java(product.getCategory().getCategoryName())", target = "categoryName")
    @Mapping(expression = "java(product.getCategory().getCategoryDescription())", target = "categoryDescription")
    @Mapping(expression = "java(product.getImage().getUrl())", target="url")
    @Mapping(expression = "java(product.getImage().getText())", target="altText")
